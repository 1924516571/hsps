...
<script>
    ...
    import {createStyle, validCoords, dateFormat, stringToStamp, getGeodesicDistance, removeOverlay,
        setLabelEvent, deepClone} from "../../utils/helpers";
    ...
    export default {
        ...
        methods: {
            ...
            createLayer(map) {
                ...
                layer.set("layerClass", "trackLayer");
                map.addLayer(layer);
            ...
            listenEvent() {
                ...
                Bus.$on(mapId + ".trackLayer.pointermove", vm.listenerMove);

                //地图空白处悬浮
                Bus.$on(mapId + ".pointermove.blank", vm.listenerMove_blank);

                Bus.$on(mapId + ".trackLayer.singleclick", vm.listenerClick);
                //地图空白处 点击
        ...
        beforeDestroy() {
            ...
            vm.getMap().then((map) => {
                ...
                Bus.$off(mapId + ".trackLayer.pointermove", vm.listenerMove);
                Bus.$off(mapId + ".pointermove.blank", vm.listenerMove_blank);
                Bus.$off(mapId + ".trackLayer.singleclick", vm.listenerClick);
