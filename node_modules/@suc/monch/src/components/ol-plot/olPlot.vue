        ...
        <slot :selectedFeature="selectedFeature">
            <template v-if="!noEdit">
                <ol-overlay class="editLay" :position="selectedFeature.layPosition" :projection="viewProjection"
                            :offset="layOffset" :single="false" v-if="selectedFeature.layPosition.length==2">
...
<script>
    ...
    import {createStyle, createOverlay, isDefined} from "../../utils/helpers";
        ...
        methods: {
            init() {
                ...
                this.getMap().then((map) => {
                    ...
                    this.createLayer(map, 'plotLayer');
