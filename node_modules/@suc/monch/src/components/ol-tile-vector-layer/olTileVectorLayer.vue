<script>
    ...
    import {coordinateTransform, isFunction, transformStyle} from "../../utils/helpers";
    import {layerMethods} from "../../utils/layer";
    ...
    export default {
        ...
        methods: {
            ...
            addLayer(map) {
                ...
                map.addLayer(layer);
                layer.set('layerClass', 'tileVectorLayer');
                return layer;
            },
        ...
        beforeDestroy() {
            ...
            vm.getMap().then((mapObject) => {
                ...
                Bus.$off(`${mapId}.pointermove`, vm.listenerEvent);
                Bus.$off(`${mapId}.singleclick`, vm.listenerEvent);
            });
            vm.selectFeature = null;
            vm.moveFeature = null;
        }
