...
<template>
  <div class="info">
      ...
      <div class="top">
          <div class="top-item">
            <div class="top-item-sub">
              <suc-input v-model="tableParams.name" placeholder="排放口名称" style="width:200px"></suc-input>
            </div>
            <div class="top-item-sub">
    ...
    <Pfk-modal :title="modalTitle" :modal="modal" :formParams="formParams" @toggle="toggle" @on-submit="oncreate"> </Pfk-modal>
...
export default class GivePlan extends Vue {
  ...
  async onpage() {
    ...
    let url = "server/dataCenter/outfall/infoList";
  ...
  setCreate() {
    this.loading = true;
    let url = "server/dataCenter/outfall/addInfo";
  ...
  async setEdit() {
    this.loading = true;
    let url = "server/dataCenter/outfall/editInfo";
  ...
  onedit(row: any) {
    ...
    this.modalTitle = "编辑";
    this.modal = true;
    let outfallid = row.outfallid;  
    this.editInfo(outfallid);
  }
  async editInfo(outfallid: any) {
    let url = "server/dataCenter/outfall/getDetail";
    let params = {
      outfallid: outfallid,
    };
  ...
  async save() {
    ...
    let url = "server/dataCenter/outfall/delInfo";
