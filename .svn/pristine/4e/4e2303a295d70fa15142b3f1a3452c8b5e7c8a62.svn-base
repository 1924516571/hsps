<template>
  ...
  <el-dialog :title="title" :visible.sync="model" :close-on-click-modal="true" :before-close="onCancel">
    <el-form :model="formParams" :rules="rules" ref="yinjForm" label-width="auto" size="small">
      <el-form-item label="堤防名称:" prop="dfmc">
        <suc-input v-model="formParams.dfmc" style="width:100%;" placeholder="请输入"></suc-input>
      </el-form-item>
      ...
      <el-form-item label="产权归属:">
        <suc-input v-model="formParams.cqgs" style="width:100%;" placeholder="请输入"></suc-input>
      </el-form-item>

      <el-form-item label="工程管理主体:">
        <suc-input v-model="formParams.gcglzt" style="width:100%;" placeholder="请输入"></suc-input>
      </el-form-item>
      ...
      <el-form-item label="行业主管部门:">
        <suc-input v-model="formParams.hyzgbm" style="width:100%;" placeholder="请输入"></suc-input>
      </el-form-item>
      <el-form-item label="管护主体:">
        <suc-input v-model="formParams.ghzt" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="所在行政村:">
        <suc-input v-model="formParams.szxzc" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="圩区:">
        <suc-input v-model="formParams.wq" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="堤防级别:">
        <suc-input v-model="formParams.dfjb" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="水普级别:">
        <suc-input v-model="formParams.spjb" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="堤外河道:">
        <suc-input v-model="formParams.dwhd" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="堤防类型:">
        <suc-input v-model="formParams.dflx" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="堤防起点:">
        <suc-input v-model="formParams.dfqd" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>

      <el-form-item label="堤防终点:">
      ...
      <el-form-item label="平均顶高(米):">
        <suc-input v-model="formParams.pjdg" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>

      <el-form-item label="平均顶宽(米):">
        <suc-input v-model="formParams.pjdk" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>

      <el-form-item label="护坡类型">
        <suc-input v-model="formParams.hplx" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>
      <el-form-item label="建设时间">
        <suc-input v-model="formParams.jssj" style="width:100%;" placeholder="请输入" ></suc-input>
      </el-form-item>

      <el-form-item label="是否划界">
        <suc-input v-model="formParams.sfhj" style="width:100%;" placeholder="请输入"></suc-input>
      </el-form-item>
...
export default class CreatePolluters1 extends Vue {
  ...
  rules = {
    dfmc: [{ required: true, message: "请输入名称", trigger: "blur" }],
