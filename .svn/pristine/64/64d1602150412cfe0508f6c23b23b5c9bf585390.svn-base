...
<template>
  ...
  <div class="info">
      ...
      <div class="top">
          <div class="top-item">
            <div class="top-item-sub">
              <suc-input v-model="tableParams.code" placeholder="水功能区编码" style="width:200px"></suc-input>
            </div>
            <div class="top-item-sub">
              <suc-input v-model="tableParams.name" placeholder="水功能区名称" style="width:200px"></suc-input>
            </div>
            <div class="top-item-sub">
    ...
    <Sgn-modal :title="modalTitle" :modal="modal" :formParams="formParams" @toggle="toggle" @on-submit="oncreate"> </Sgn-modal>
...
export default class GivePlan extends Vue {
  ...
  async onpage() {
    ...
    let url = "server/datacenter/waterFunction/page";
  ...
  setCreate() {
    this.loading = true;
    let url = "server/datacenter/waterFunction";
  ...
  exportExcel() {
    let consturl = url + "/api/server/datacenter/waterFunction/export"
