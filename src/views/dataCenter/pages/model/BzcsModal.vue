<template>
  <el-dialog :title="title" :visible.sync="model" :close-on-click-modal="true" :before-close="onCancel">
    <el-form :model="formParams" :rules="rules" ref="yinjForm" label-width="auto" size="small">
      <el-form-item label="避灾场所名称:" prop="name">
        <el-input v-model="formParams.name" placeholder="请输入"></el-input>
      </el-form-item>

      <el-form-item label="可容纳的人数:">
        <el-input v-model.number="formParams.num" type="number" placeholder="请输入"></el-input>
      </el-form-item>
      ...
      <el-form-item label="负责人:">
        <el-input v-model="formParams.people" placeholder="请输入"></el-input>
      </el-form-item>

      <el-form-item label="负责人电话:" prop="tel">
        <el-input v-model.number="formParams.tel" type="number" placeholder="请输入"></el-input>
      </el-form-item>
