  ...
  <el-dialog title="分配房屋" :visible.sync="modal" :close-on-click-modal="true" :before-close="onCancel">
   <el-descriptions style="margin-bottom:20px" class="margin-top" title="基础信息" :column="2" size="medium" border labelStyle="width:150px">
    ...
    <el-form :model="formParams" ref="fpForm" label-width="auto" size="small">
      ...
      <div class="title">续租登记</div>
      <el-form-item label="开始时间:" style="display: inline-block;width:45%;margin-right:20px">
        <suc-date-picker
            v-model="formParams.reletStartdate"
            :options="{
              type: 'date',
              clearable: true,
              placeholder: '选择时间',
      ...
      <el-form-item label="结束时间:" style="display: inline-block;width:45%;margin-right:20px">
        <suc-date-picker
            v-model="formParams.reletEnddate"
            :options="{
              type: 'date',
              clearable: true,
              placeholder: '选择时间',
      ...
      <el-form-item label="租金/月(元):" style="display: inline-block;width:45%;margin-right:20px">
        <suc-input v-model="formParams.reletFee" style="width:100%" placeholder="请输入"></suc-input>
      </el-form-item>

      <el-form-item label="租金总额(元):" style="display: inline-block;width:45%">
        <suc-input v-model="formParams.reletTotal" style="width:100%" placeholder="请输入"></suc-input>
      </el-form-item>
...
export default class XzModal extends Vue {
