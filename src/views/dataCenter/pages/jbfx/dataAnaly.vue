    ...
    <div class="top">
      <div class="top-item">
        <div class="top-item-sub">
            <suc-select v-model="tableParams.communityUuid" @on-change="onChangeHouse" :options="houseOptions" :config="{ placeholder: '小区名称', clearable: true }" style="width:160px"></suc-select>
        </div>
      </div>
    </div>
    <h3>保障住房数据分析</h3>
